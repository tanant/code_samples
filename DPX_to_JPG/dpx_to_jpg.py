...
def convert_dir(directory, overwrite=False, binary_override=None, spawn_instances=1):
    ...
    if binary_override is None:
        if sys.platform == 'darwin':
            # this still needs to be scavenged potentially due to the macos
            # annoying mounts system (read: AFP/CIFS/suffix-appending misery)
    ...
    extra_args = [r'-i', '{infile}',            # input file
                  ...
                  r'{overwrite_flag}',          # a simple -y/-n flag
